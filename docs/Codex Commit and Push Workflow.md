...
1. `docs/Git Collaboration Convention.md`를 읽는다.
2. 이 문서 `docs/Codex Commit and Push Workflow.md`를 읽는다.
...
`type`은 반드시 `docs/Git Collaboration Convention.md`의 Commit Type 표를 따른다.
...
PR 본문은 `docs/Git Collaboration Convention.md`의 PR Description Template을 따른다.
