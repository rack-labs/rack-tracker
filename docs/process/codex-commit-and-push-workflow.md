...
1. `docs/process/git-collaboration-convention.md`를 읽는다.
2. 이 문서 `docs/process/codex-commit-and-push-workflow.md`를 읽는다.
...
`type`은 반드시 `docs/process/git-collaboration-convention.md`의 Commit Type 표를 따른다.
...
PR 본문은 `docs/process/git-collaboration-convention.md`의 PR Description Template을 따른다.
